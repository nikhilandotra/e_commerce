...
const sortProducts = (e) => {
    let fillterProductsCopy  = filteredProducts.slice();
    switch(sortType){
       
        case "low-high":
            setFilteredProducts(fillterProductsCopy.sort((a,b) => a.price - b.price))
            break;
        case "high-low":
            setFilteredProducts(fillterProductsCopy.sort((a,b) => b.price - a.price))
            break;
